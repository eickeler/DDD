...
! The inferior debugger type. One of: bash, dbx, gdb, jdb, remake, perl, pydb, 
!	                              or xdb.
Ddd*debugger: gdb
...
! `@FILE@' by the file name.  Default is to invoke gvim then emacs.
! then $EDITOR, then VI.
Ddd*editCommand: \
gvim @FILE@ +@LINE@ \
|| emacs +@LINE@ @FILE@
...
Ddd*defaultFont:       Liberation Sans

! The font to use for help texts.
Ddd*variableWidthFont: Liberation Sans
...
DESC(Reload Program, [reloads the currently used program])\n\
...
Ddd*menubar*fileMenu.reload_exec.labelString: Reload Program
Ddd*menubar*fileMenu.reload_exec.mnemonic:    P
